...
/**
*  This class is used be widgets to painting scrollbars.
*  There isn't a scrollbar widget in the library, instead of this,
*  instead of this widget's that has scrollbars as part, use this class for painting.
*/
